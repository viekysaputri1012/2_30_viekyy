            ...
            <div class="container-fluid">
                ...
                <form method="POST" action="/update_contact">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input type="text" class="form-control" id="floatingInput" placeholder="Nama" name="nama" value="{{ $c->nama }}">
                    </div>
                    <div class="form-floating mb-3">
                        <label for="floatingInput">Email</label>
                        <input type="email" class="form-control" id="floatingInput" placeholder="Email" name="email" value="{{ $c->email }}">
                    </div>
                    <div class="form-floating mb-3">
